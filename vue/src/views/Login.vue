<template>
  <div>
    <img class="mx-auto h-[150px] w-auto" src="../assets/img/logo.svg"
      alt="Sushi">
  ...
  <form class="mt-8 space-y-6" @submit.prevent="login">
    ...
    <div class="text-center">
      <button type="submit"
        class="group relative flex w-full justify-center rounded-md border border-transparent bg-[#1ba39a] py-2 px-4 text-sm font-medium text-white hover:bg-[#1ba39aab] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
      ...
      Or <br>
      New user?
      <router-link :to="{name: 'registeration'}" class="font-medium text-indigo-600 hover:text-indigo-500">Registeration
      </router-link>
    </div>
  </form>
</template>
