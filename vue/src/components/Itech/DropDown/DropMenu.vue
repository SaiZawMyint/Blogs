<template>
    <div class="w-full my-2 px-3">
        <button class="flex w-full border-2 rounded-lg justify-between p-2"
        @click="expandFn">
            <label>{{title}}</label>
        ...
        <div class="overflow-y-auto overflow-x-hidden border-2 rounded mt-1" :style="expend ? 'display:block':'display:none'"
