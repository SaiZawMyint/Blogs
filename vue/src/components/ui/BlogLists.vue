<template>
    <div class="flex flex-col p-2 max-w-[600px] mx-auto">
            ...
            <div class="px-4 py-2 flex border-t-2 border-gray-300">
                <div class="p-2 bg-gray-200 rounded-lg flex mr-2">
                    <button
                        ...
                        <svg v-if="data.isliked" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-4 h-4">
        ...
        <p class="italic text-gray-400 py-3">There is no blogs yet! Create a blogs to new feed!</p>
            <button class="px-3 py-2 rounded-lg bg-gray-200 hover:bg-gray-200/40" @click="store.state.modalBox.createfn">Create New Blogs</button>
        </div>
    </div>
</template>
<script setup>
