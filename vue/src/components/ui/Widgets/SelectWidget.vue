  ...
  <div class="relative" @mousedown.prevent="">
    ...
    <Transition name="select-box">
      <div :class="max.height" v-if="editorData.show" tabindex="-1" ref="selectBox" @blur.prevent="editorData.show = false"
       @mousedown.prevent=""
        class="flex overflow-y-auto flex-col w-full absolute top-[110%] rounded shadow-lg bg-white/50 border-2 outline-0 border-gray-300 shadow-lg backdrop-blur focus:outline-none">
        <button 
